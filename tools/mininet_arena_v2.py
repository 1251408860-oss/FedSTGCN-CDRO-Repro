...
PCAP_FILE = os.path.abspath(os.environ.get("PCAP_FILE", os.path.join(REPO_ROOT, "full_arena_v2.pcap")))
MANIFEST_FILE = os.path.abspath(os.environ.get("MANIFEST_FILE", os.path.join(REPO_ROOT, "arena_manifest_v2.json")))
...
ATTACK_SCRIPT = os.path.join(TOOLS_DIR, "bot_attack.py")
BENIGN_SCRIPT = os.path.join(TOOLS_DIR, "benign_traffic.py")
LOCUST_SCRIPT = os.path.join(TOOLS_DIR, "benign_user.py")
TARGET_SERVER_SCRIPT = os.path.join(TOOLS_DIR, "target_server.py")
PAYLOAD_FILE = os.path.join(REPO_ROOT, "llm_payloads.json")
