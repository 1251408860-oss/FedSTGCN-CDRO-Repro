...
PCAP_FILE = os.path.join(REPO_ROOT, "full_arena_v2.pcap")
OUTPUT_FILE = os.path.join(REPO_ROOT, "st_graph.pt")
MANIFEST_FILE = os.path.join(REPO_ROOT, "arena_manifest_v2.json")
