...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--graph-file", default=os.path.join(REPO_ROOT, "st_graph.pt"))
    parser.add_argument("--model-file", default=os.path.join(REPO_ROOT, "fed_pignn_model.pt"))
    parser.add_argument("--results-file", default=os.path.join(REPO_ROOT, "phase4_federated_results.json"))
