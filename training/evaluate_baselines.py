...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--graph-file", default=os.path.join(REPO_ROOT, "st_graph.pt"))
    p.add_argument("--pi-model-file", default=os.path.join(REPO_ROOT, "pi_gnn_model.pt"))
    p.add_argument("--output-file", default=os.path.join(REPO_ROOT, "baseline_eval_results.json"))
